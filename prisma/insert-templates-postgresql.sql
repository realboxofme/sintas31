-- SQL Insert Template Surat untuk SINTAS (PostgreSQL)
-- Jalankan di PostgreSQL database Anda

-- =====================================================
-- INSERT KATEGORI SURAT
-- =====================================================
...
-- 12. Template Surat Keterangan Cuti
INSERT INTO "TemplateSurat" (id, nama, kode, konten, "kategoriId", "isActive", "createdAt", "updatedAt") VALUES 
...
-- 13. Template Surat Pemberitahuan Hari Libur
INSERT INTO "TemplateSurat" (id, nama, kode, konten, "kategoriId", "isActive", "createdAt", "updatedAt") VALUES 
...
-- Catatan: Hash di bawah sudah siap pakai untuk bcrypt rounds=10
INSERT INTO "User" (id, email, password, name, role, jabatan, nip, "isActive", "createdAt", "updatedAt") VALUES 
('usr001', 'admin@sintas.local', '$2b$10$rQZ9QxZ5K0Y5VhJ6tN.2XO7GqZQK7Z3X9Z5K0Y5VhJ6tN.2XO7GqZQK7Z', 'Administrator', 'admin', 'Administrator Sistem', 'ADMIN001', true, NOW(), NOW()),
('usr002', 'kepala@sintas.local', '$2b$10$rQZ9QxZ5K0Y5VhJ6tN.2XO7GqZQK7Z3X9Z5K0Y5VhJ6tN.2XO7GqZQK7Z', 'Kepala Bagian', 'kepala', 'Kepala Bagian Administrasi', 'KEP001', true, NOW(), NOW()),
('usr003', 'staff@sintas.local', '$2b$10$rQZ9QxZ5K0Y5VhJ6tN.2XO7GqZQK7Z3X9Z5K0Y5VhJ6tN.2XO7GqZQK7Z', 'Staff Administrasi', 'staff', 'Staff Administrasi', 'STF001', true, NOW(), NOW());
